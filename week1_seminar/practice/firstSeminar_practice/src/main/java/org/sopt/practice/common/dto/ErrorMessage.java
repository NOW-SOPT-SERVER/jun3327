...
public enum  ErrorMessage {
    ...
    JWT_ACCESS_TOKEN_EXPIRATION_EXCEPTION(HttpStatus.UNAUTHORIZED.value(), "access-token의 기간이 만료되었습니다."),
    JWT_REFRESH_TOKEN_EXPIRATION_EXCEPTION(HttpStatus.UNAUTHORIZED.value(), "refresh-token의 기간이 만료되었습니다.");
